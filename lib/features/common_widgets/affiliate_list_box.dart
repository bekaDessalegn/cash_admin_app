...
Widget affiliateListBox({required BuildContext context, required Affiliates affiliate}){
  return MouseRegion(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                affiliate.avatar!.path == "null" ? Container(
                  width: 70,
                  height: 70,
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(100),
                    child: smallImage(urlImage: "$baseUrl${affiliate.avatar!.path}")),
                Expanded(
                  child: Container(
                    height: 84,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            text: "${affiliate.wallet.totalMade.toStringAsFixed(2)} ",
